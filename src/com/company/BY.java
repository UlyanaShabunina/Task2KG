...
public class BY {
    public void BYLine (int x1, int y1, int x2, int y2, Graphics g) {
        ...
        if (dx > dy) {
            ...
            for (int x = x1; x < x2; ++x) {
                g.setColor(new Color(125,130,130, (int) (255 - fractionalPart(intery) * 255))); //Меняем прозрачность
                g.drawLine(x, (int)intery, x, (int)intery);
                g.setColor(new Color(125,130,130, (int) (fractionalPart(intery) * 255)));
            ...
            g.drawLine(x1, y1, x1, y1);
            for (int y = y1; y < y2; ++y) {
                g.setColor(new Color(125,130,130, (int) (255 - fractionalPart(interx) * 255)));
                g.drawLine((int)interx, y, (int)interx, y);
                g.setColor(new Color(125,130,130, (int) (fractionalPart(interx) * 255)));
